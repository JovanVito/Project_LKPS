...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # <--- UBAH BAGIAN INI
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')# Pastikan ada garis miring di depan dan belakang

# TANDA KURUNG SIKU INI WAJIB ADA
STATICFILES_DIRS = [
